...
const EventCard = ({ active, data }) => {
  ...
  return (
    <div
      ...
      // className=
      // {`w-full block bg-white rounded-lg ${  active ? "unset" : "mb-12"} lg:flex p-2`}
    >
      <div className="w-full lg:-w[50%] m-auto">
        {/* <img src={`${data.images[0]?.url}`} alt="" /> */}
        <img
          src=" https://i.pinimg.com/236x/85/d8/40/85d8405f758250a8d5ebf5d7bd98671d.jpg"
          height="400px"
          width="500px"
        />
      </div>
      ...
      <div className="w-full lg:[w-50%] flex flex-col justify-center">
        ...
        <p>
          ...
          saepe nulla providentLorem ipsum dolor sit amet consectetur,
          adipisicing elit. Beatae, assumenda? Quisquam itaque exercitationem
          labore vel, dolore quidem asperiores, laudantium temporibus soluta
          optio consequatur aliquam deserunt officia. Dolorum saepe nulla
          provident.
        </p>
